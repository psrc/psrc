...
describe Admin::PageController do
  ...
  #   get :index
  #   response.should be_success
  #   cookies['expanded_rows'].should == '1,5,9,10,11,12,52'
  #   assert_rendered_nodes_where { |page| [nil, 1, 5, 9, 52, 10, 11, 12].include?(page.parent_id) }
  # end
  
  it "should index__with_mangled_cookie" #do
  #   write_cookie('expanded_rows', '1,5,:#*)&},9a,,,')
  #   get :index
  #   response.should be_success
  #   cookies['expanded_rows'].should == '1,5,:#*)&},9a,,,'
